...
````````{r}
traindata<- read.csv("Assignment_train.csv", na.strings =c("")) 
colnames(traindata) <- c('ID', 'Current_Acct', 'Credit_History', 'Loan_Reason', 'Savings_Acct', 'Employment', 'Personal_Status', 'Housing', 
               'Job_Type', 'Foreign_National', 'Length_Current_Acct(Months)', 'Residence_Time(Years)', 'Age', 'Credit_Standing') 
names(traindata)
head(traindata)
dim(traindata) 
View(traindata) 
...
```````````{R} 
table(Finaltrain$Employment) # short term work is meadian s=as it occurs most often
Finaltrain$Employment[is.na(Finaltrain$Employment)] <- "Short" # fill in median for ramdon foresst
sum(is.na(Finaltrain$Employment))
sum(is.na(Finaltrain$Personal_Status))
table(Finaltrain$Personal_Status) # single is meadia value ioccurs most often
Finaltrain$Personal_Status[is.na(Finaltrain$Personal_Status)] <- "Single"
sum(is.na(Finaltrain$Personal_Status))
sum(is.na(Finaltrain$Housing))
table(Finaltrain$Housing) # own is meadia value ioccurs most often
Finaltrain$Housing[is.na(Finaltrain$Housing)] <- "Own"

sum(is.na(Finaltrain))
...
Credit_Scoring=data.frame(Finaltrain) 
...
Credit_Scoring.Model=rpart(Credit_Standing~ Current_Acct+Credit_History+Loan_Reason+Savings_Acct+Employment+Personal_Status+Housing+ 
                            Job_Type+Foreign_National+Length_Current_Acct.Months.+Residence_Time.Years.+Age, 
                          data=Credit_Scoring)
tree.pred=predict(Credit_Scoring.Model,Credit_Scoring.test,type="class")
...
Scoring_Data$Loan_Reason <- as.character(Scoring_Data$Loan_Reason)
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Car Used"] <- "Car"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Car New"] <- "Car"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Small Appliance"] <- "Household" 
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Large Appliance"] <- "Household"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Furniture"] <- "Household"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Business"] <- "Business"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Education"] <- "Education"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Retraining"] <- "Education"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Other"] <- "Other"
Scoring_Data$Loan_Reason[Scoring_Data$Loan_Reason== "Repairs"] <- "Other"
Scoring_Data$Loan_Reason <- as.factor(Scoring_Data$Loan_Reason)
